...
HD_PWD='C:/Xilinx/workspace/study/practice_GATE/practice_GATE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log program_not.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source program_not.tcl -notrace
