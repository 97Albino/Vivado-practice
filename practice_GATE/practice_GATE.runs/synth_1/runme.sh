...
HD_PWD='C:/Xilinx/workspace/study/practice_GATE/practice_GATE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log program_not.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source program_not.tcl
